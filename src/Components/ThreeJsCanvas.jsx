...
import map from "../assets/blue.png";
import {
  Cloud,
  Clouds,
  OrbitControls,
...
const CloudMaterial = shaderMaterial(
  {
    ...
    iChannel0: new THREE.TextureLoader().load(map),
    iChannel1: new THREE.TextureLoader().load(map),
    iChannel2: new THREE.TextureLoader().load(map),
    iChannel3: new THREE.TextureLoader().load(map),
    iTimeDelta: 0,
      ...
      >
        ...
        <Clouds material={THREE.MeshBasicMaterial}>
          <Cloud
            ...
            concentrate="random"
            growth={0.5}
            // distribute={(i) => [i % 50, Math.floor(i / 50), 0]}
            color="orange"
          />
